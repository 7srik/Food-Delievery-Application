...
public class SystemDoctorjPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jDeletebtn, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jEmailidtxt, jUsernametxt});
    ...
    private void jDeletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDeletebtnActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) jDoctortbl.getModel();
        if (jDoctortbl.getSelectedRowCount()==1) {
          model.removeRow(jDoctortbl.getSelectedRow());
          JOptionPane.showMessageDialog(this, "Doctor Profile deleted.");
        }
        else{
            if(jDoctortbl.getSelectedRowCount()==0){
